...
public class NettyClient {
    ...
    public NettyClient(ClientCloudStorage clientCloudStorage) {
        this.clientCloudStorage = clientCloudStorage;
        this.IP_ADDR = clientCloudStorage.getIP_ADDR();
        this.PORT = clientCloudStorage.getPORT();
    }
            ...
            b.handler(new ChannelInitializer<SocketChannel>() {
                protected void initChannel(SocketChannel socketChannel)/* throws Exception*/ {
                    ...
                    socketChannel.pipeline().addLast(
                            ...
                            new ClientCommandMessageManager(clientCloudStorage)
                            //new ClientCommandMessageManager(clientCloudStorage)
                    );
                }
            });
    ...
    public void onConnectionReady(ChannelFuture future) {
        System.out.println("Waiting for the server answer...");
    }
